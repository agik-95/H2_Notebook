...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2020 at 09:22 AM
...
-- Database: `h2notebook`
--
CREATE DATABASE IF NOT EXISTS `h2notebook` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `h2notebook`;
...
CREATE TABLE `data_laptop` (
  ...
  `TipeLaptop` varchar(20) NOT NULL,
...
INSERT INTO `data_laptop` (`ID`, `Kondisi`, `TipeLaptop`, `Harga`, `Deskripsi`, `Keterangan`, `Gambar`) VALUES
(1, 'asu', 'Asus Vivo', 'Rp.3.000.000', 'Processor Intel® Core™ i5-8250U processor 1.6GHz quad-core with Turbo boost (up to 3.4GHz) and 6MB cache Graphics NVIDIA® GeForce® MX150 Video memory size: 2GB GDDR5 VRAM Display 14” LED-backlit Full HD (1920 x 1080) 16:9 matte display Advanced three-sided NanoEdge display with 84% screen-to-body ratio 178° wide-view technology ASUS Eye Care technology for up to 30% blue-light reduction Memory 8GB 2400MHz DDR4 Storage Dual Storage: 256GB SATA SSD + 1TB HDD Interfaces', 'Garansi 2 tahun ya mas, jangan lupa bonusin Mouse sama keyboard', '1.jpg'),
(2, 'baru', 'Toshiba ', 'Rp.5.000.000,-', 'N3350 1.10-2.40GHz/2GB/500GB/Intel HD/11.6?/DOS/NO DVD/Cam/BT / BLACK', 'bagus all of it', '2.jpg'),
(3, 'bekas', 'Laptop asura', 'Rp.5.000.000,-', 'N3350 1.10-2.40GHz/2GB/500GB/Intel HD/11.6?/DOS/NO DVD/Cam/BT / BLACK', 'ngising o beling wae mas koowe ki. yo lik jancuk emang', '2.jpg');
...
(1, 'ashka', 'dsfsdfgsdfsd'),
(2, 'admin', '$2y$10$0QXCoCKUXxq9z4H4G2dH7ONr3TrCEWB5xZ0ySAyftkh0t.FOiexjK'),
(3, 'jancuk', '$2y$10$xFE4ppUX8liUUA5kpMpuR.brmzl6r7WfsV03aN6qIXf3dP7V2OSke');
...
-- Database: `looogin`
--
CREATE DATABASE IF NOT EXISTS `looogin` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `looogin`;
...
INSERT INTO `users` (`id`, `email`, `forename`, `password`, `salt`, `surname`) VALUES
(1, 'admin@mail.com', 'Admin', 'ea2959d87ea2974afcd45c6224d2e5322bc349db8e65f8a3c7460e2a8fb9a883', '>TrKAx^/<E^+aX!-5K|}pL!Po9(gH_Fr', 'Admin');
...
--
CREATE DATABASE IF NOT EXISTS `onlinehospitalmanagementsystem` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `onlinehospitalmanagementsystem`;
...
(83, '', 22, 0, 12, '2016-03-17', '02:00:00', 0, 'Approved', 'Test appointment record'),
...
(39, 22, 83, '2020-03-18', '18:44:38', 0.00, 0.00, '', '00:00:00', '0000-00-00');
...
(35, 'Lokesh Kumar Chopra', '9812453678', 12, 'doctor', '123456789', 'Active', 'MBBS,MD,IDCCM', 7.0, 700.00),
...
(58, 'asssa', '2020-03-18', '18:37:01', 'asdaa', 'sdas', 'dasd', 'asdas', 'dasda', 'asking12345', 'A+', 'MALE', '2020-03-16', 'Active');
...
(22, '1232234', 'Erik', 'erik@gmail.com', 'Teknik Industri', 'erik.jpg'),
...
(1, 'jonoo', '12123123', 'y!@gmail,com', 'mesin'),
(2, 'aris', '1161234213', 't@gmail.com', 'palku'),
(3, 'jono teriak', '1235121232', 'yoko.crutz@gmail.com', 'Teknik Industri'),
(4, 'waws', '31254235234321', 'weawe@gmai.com', 'Teknik Informatika');
...
('suzukimobilyogya', 'Varian_Mobil', 'varchar', '20', 'latin1_swedish_ci', 0, ',', ''),
('suzukimobilyogya', 'Varian_Mobil1', 'varchar', '25', 'latin1_swedish_ci', 0, ',', ''),
('suzukimobilyogya', 'id', 'int', '5', '', 0, 'auto_increment,', '');
...
('root', '[{\"db\":\"h2notebook\",\"table\":\"user\"},{\"db\":\"looogin\",\"table\":\"users\"},{\"db\":\"myapp\",\"table\":\"users\"},{\"db\":\"myapp\",\"table\":\"user_cookies\"},{\"db\":\"mysql\",\"table\":\"user\"},{\"db\":\"phpmvc\",\"table\":\"mahasiswa\"},{\"db\":\"users\",\"table\":\"users\"},{\"db\":\"login\",\"table\":\"users\"},{\"db\":\"login\",\"table\":\"notes\"},{\"db\":\"phpdasar\",\"table\":\"user\"}]');
...
('root', 'h2notebook', 'data_laptop', '{\"sorted_col\":\"`data_laptop`.`Kondisi`  DESC\"}', '2020-04-16 10:56:20'),
('root', 'phpdasar', 'mahasiswa', '{\"CREATE_TIME\":\"2020-03-26 12:37:13\",\"col_order\":[0,2,1,3,4,5],\"col_visib\":[1,1,1,1,1,1],\"sorted_col\":\"`mahasiswa`.`gambar`  DESC\"}', '2020-04-01 09:51:37'),
('root', 'phpdasar', 'user', '{\"sorted_col\":\"`user`.`username`  DESC\"}', '2020-04-16 11:51:45');
...
('root', '2020-04-21 07:21:07', '{\"Console\\/Mode\":\"collapse\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Database: `suzukimobilyogya`
--
CREATE DATABASE IF NOT EXISTS `suzukimobilyogya` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `suzukimobilyogya`;
...
CREATE TABLE `mobil` (
  ...
  `Varian_Mobil` varchar(20) NOT NULL,
  `Varian_Mobil1` varchar(25) NOT NULL,
  `Harga_AT2` varchar(25) NOT NULL,
  `Varian_Mobil2` varchar(25) NOT NULL,
  `Harga_AT` varchar(25) NOT NULL,
  `Harga_AT1` varchar(25) NOT NULL,
  `Harga_MT` varchar(25) NOT NULL,
  `Harga_MT1` varchar(25) NOT NULL,
  `Harga_MT2` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `mobil` (`id`, `Kondisi`, `Gambar`, `Tipe_Mobil`, `Deskripsi`, `Varian_Mobil`, `Varian_Mobil1`, `Harga_AT2`, `Varian_Mobil2`, `Harga_AT`, `Harga_AT1`, `Harga_MT`, `Harga_MT1`, `Harga_MT2`) VALUES
(1, 'BARU ', 'XL7.jpg', 'Suzuki XL 7', 'silahkan hubungi kami: 0818469219', 'Beta', 'Alpha', 'Rp.250.0000', 'Zeta', 'Rp.50.0000', 'Rp.150.0000', 'Rp.250.0000', 'Rp.250.0000', 'Rp.250.0000'),
(2, '', 'baleno.jpg', 'Suzuki Baleno', 'silahkan hubungi kami: 0818469219', 'burow', 'asembil', 'Rp.15.000', 'darkness', 'Rp.2245455', 'Rp.45645645', 'Rp.456546', 'Rp.564564', 'Rp.456456456');
